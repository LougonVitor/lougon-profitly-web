...
export const translations = {
  pt: {
    ...
    fixedIncome: {
      selectorLabel: 'Tipo de ativo',
      market: 'Ação / FII / Cripto / Tesouro',
      optionLabel: 'Renda Fixa (CDB/LCI/LCA/LC/LF/RDB)',
      issuer: 'Emissor',
      instrumentType: 'Tipo de título',
      indexer: 'Indexador',
      rateCdi: 'Taxa do CDI',
      rateSelic: 'Taxa da Selic',
      rateIpca: 'Taxa do IPCA+ (a.a.)',
      ratePrefixado: 'Taxa Pré-fixada (a.a.)',
      dailyLiquidity: 'Liquidez diária',
      principal: 'Valor aplicado',
      ...
      indexerSelic: 'Selic',
      indexerIpca: 'IPCA+',
      indexerPrefixado: 'Prefixado',
      redeem: 'Resgatar',
      redeeming: 'Resgatando...',
      redeemTitle: 'Resgatar posição',
      redeemText: (name: string) =>
        `Confirma o resgate de "${name}"? O valor acumulado até a data escolhida será registrado como venda, encerrando a posição.`,
      redeemDate: 'Data do resgate',
  ...
  en: {
    ...
    fixedIncome: {
      ...
      market: 'Stock / FII / Crypto / Treasury',
      optionLabel: 'Fixed Income (CDB/LCI/LCA/LC/LF/RDB)',
      issuer: 'Issuer',
      instrumentType: 'Instrument type',
      indexer: 'Index',
      rateCdi: 'CDI rate',
      rateSelic: 'Selic rate',
      rateIpca: 'IPCA+ rate (p.a.)',
      ratePrefixado: 'Fixed rate (p.a.)',
      dailyLiquidity: 'Daily liquidity',
      ...
      indexerSelic: 'Selic',
      indexerIpca: 'IPCA+',
      indexerPrefixado: 'Fixed',
      redeem: 'Redeem',
      redeeming: 'Redeeming...',
      redeemTitle: 'Redeem position',
      redeemText: (name: string) =>
        `Confirm redeeming "${name}"? The accrued value up to the chosen date will be recorded as a sale, closing the position.`,
  ...
  es: {
    ...
    fixedIncome: {
      selectorLabel: 'Tipo de activo',
      market: 'Acción / FII / Cripto / Tesoro',
      optionLabel: 'Renta Fija (CDB/LCI/LCA/LC/LF/RDB)',
      issuer: 'Emisor',
      instrumentType: 'Tipo de título',
      indexer: 'Índice',
      rateCdi: 'Tasa del CDI',
      rateSelic: 'Tasa de la Selic',
      rateIpca: 'Tasa del IPCA+ (a.a.)',
      ratePrefixado: 'Tasa prefijada (a.a.)',
      dailyLiquidity: 'Liquidez diaria',
      principal: 'Valor aplicado',
      transactionDate: 'Fecha de la transacción',
      maturityDate: 'Fecha de vencimiento',
      totalValue: 'Valor total',
      add: '+ Agregar lanzamiento',
      adding: 'Agregando...',
      indexerCdi: 'CDI',
      indexerSelic: 'Selic',
      indexerIpca: 'IPCA+',
      indexerPrefixado: 'Prefijada',
      redeem: 'Rescatar',
      redeeming: 'Rescatando...',
      redeemTitle: 'Rescatar posición',
      redeemText: (name: string) =>
        `¿Confirma el rescate de "${name}"? El valor acumulado hasta la fecha elegida se registrará como venta, cerrando la posición.`,
      redeemDate: 'Fecha del rescate',
